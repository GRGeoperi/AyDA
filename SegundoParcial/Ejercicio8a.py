...
def bruteForce_dictionary(N, Dictionary, Interval):
    ...
    for i in range(1, N + 1): # O(n)
        ...
        ''' combinations es una tupla (lista inmutable)
        ...
        '''
        combinations = itertools.combinations(Dictionary.items(), i) # O(2^n)
        # Probar cada combinación
        ''' combination es cada uno de los elementos en la tupla de combinaciones,
            es decir:
            9C1 = [A,B,C,D,E,F,G,H,I] = 9
            9C2 = [AB,AC,AD,AE,AF,AG,AH,AI,BC,...,HI] = 36
            ...
    ...
    return dict(bestCombination) if bestCombination else {} # O(1)
